...
#define IT(ITER_CLASS, TYPE)                                                  \
  typename dvfw::gen::base_generator<ITER_CLASS, TYPE>::iterator begin() {    \
    return                                                                    \
        typename dvfw::gen::base_generator<ITER_CLASS, TYPE>::iterator(this); \
  };                                                                          \
  typename dvfw::gen::base_generator<ITER_CLASS, TYPE>::iterator end() {      \
    return typename dvfw::gen::base_generator<ITER_CLASS, TYPE>::iterator(    \
        nullptr);                                                             \
  };
